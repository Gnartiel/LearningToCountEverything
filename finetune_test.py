...
anno_file = data_path + '/test_data_annotation_final.txt'
im_dir = data_path + '/test_data/images'
...
print('On {} data, MAE: {:6.2f}, RMSE: {:6.2f}'.format("testing", SAE/cnt, (SSE/cnt)**0.5))
